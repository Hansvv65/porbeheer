...
auditLog($pdo, 'PAGE_VIEW', 'admin/beheer.php');
?>
<!DOCTYPE html>
<html lang="nl">
<head>
  ...
  <style>
    ...
    /* Bezochte links */
    .tile:visited {
        color: #ffd86b;   /* warme goud/amber tint, goed zichtbaar op donkere achtergrond */
        text-shadow: 0 0 6px rgba(255, 216, 107, 0.6);
    }

    /* Hover blijft dominant */
    .tile:hover {
      color: #ffffff;
    }
